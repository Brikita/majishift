...
All reservoir and operating numbers are deliberately invented, including capacity (20,000 m³), surface area, initial storage, reserve, demand, pump delivery and outage. The historical replay uses official Conduit CSV daily rain and temperature-derived reference evapotranspiration. When the live feed succeeds, the environmental card also uses the latest station reading; one live cumulative snapshot is not converted into a daily increment. The prototype makes no savings, drinking-water quality, forecast or equipment-control claim.
