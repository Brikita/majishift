...
All reservoir and operating numbers are deliberately invented, including capacity (20,000 m³), surface area, initial storage, reserve, demand, pump delivery and outage. When the feed succeeds, only Day 1 rain and the environmental observation card use the latest public Conduit station reading. Days 2–7 remain scenarios. The prototype makes no savings, drinking-water quality, forecast or equipment-control claim.
