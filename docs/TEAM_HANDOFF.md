...
| AI | Adaptive Data completed 160 rows; strict-label 30B Nemotron AutoScientist run completed 3 iterations with 0.5371 best win rate; enhanced-label comparison has completed 2/3 iterations with a 0.5567 best score so far; 20 cases remain held out | Evaluate both checkpoints on untouched cases; select honestly; securely serve the selected checkpoint; keep operator review |
