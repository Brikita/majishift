...
| AI | Two 30B Nemotron runs completed at 0.5371 and 0.5567; a corrected Gemma 4B run uses fused context, 160 source rows and 840 domain rows; 20 cases remain held out | Evaluate checkpoints on untouched cases; select honestly; securely serve the selected checkpoint; keep operator review |
